<template>
  <n-modal v-model:show="statusStore.showInfoDialog" preset="card" style="width: 360px" :auto-focus="false"
    header-style="display: none" content-style="padding: 0 32px 24px 32px;" :bordered="false">
      ...
      <div class="info" @click="toUploadInfo">
        ...
        <p class="user-title" @click.stop="copyID">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
            <g fill="none" stroke="#64748B" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
              <path
    ...
    <div v-if="isVip" class="vip-membership-card">
      <div class="vip-membership-content">
        ...
        <n-button class="vip-renew-button" @click="handleRenewClick">{{ $t('btnProfile.product.renewNow') }}</n-button>
      </div>
    </div>
    <div class="financial" :class="{ 'vip-connected': isVip }">
      ...
      <div class="balance">
        <n-tooltip placement="top-start" trigger="hover">
          <template #trigger>
            <span class="num">{{ statusStore.userWallte.total_balance || 0
    ...
    <div class="handles">
      <div class="handles-item" @click="toAllCoinList('all')">
        <span class="icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
            <g fill="none" stroke="#CBD5E1" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
      ...
      <div class="handles-item" @click="statusStore.showRecordDialog = true">
        <span class="icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
            <path fill="none" stroke="#CBD5E1" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"
