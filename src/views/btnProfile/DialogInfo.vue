<template>
  ...
  >
    <div class="info-container" :class="{ 'vip-container': statusStore.usersMetadata.level === 2 }">
      <div class="avatar-wrapper" :class="{ 'vip-avatar-wrapper': statusStore.usersMetadata.level === 2 }">
