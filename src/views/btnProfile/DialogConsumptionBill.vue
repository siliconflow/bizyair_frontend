      ...
      <div class="tab-header">
        <div class="tab-title-wrapper">
          <n-breadcrumb>
            ...
            <n-breadcrumb-item
              v-if="currentBillLevel === 'monthly' || currentBillLevel === 'daily'"
              @click="backToMonthly"
            >
    ...
    },
    {
      ...
      render() {
        return h(
          ...
          { trigger: 'hover', placement: 'top' },
          {
            default: () => t('btnProfile.consumptionBill.monthlyBill'),
            trigger: () => {
              return h(
                'svg',
                {
    ...
    },
    {
      ...
      render() {
        return h(
          ...
          { trigger: 'hover', placement: 'top' },
          {
            default: () => t('btnProfile.consumptionBill.dailyBill2'),
            trigger: () => {
              return h(
                'svg',
                {
