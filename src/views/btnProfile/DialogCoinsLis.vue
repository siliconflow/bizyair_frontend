<template>
  <div class="info-container">
    ...
    <div class="total-amount">
      <div class="total-amount-item">
        <p class="total-amount-title">
          <img src="https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/web/AdLFMb6DyYnpsJArdSpbPz8P7SzMFw3u.webp" alt="">
          即过期的金币总额
        </p>
      ...
      <div class="total-amount-item">
        <p class="total-amount-title">
          <img src="https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/web/FLrDPYmbuUnXSygQF1iePicnQwbPSWXD.webp" alt="">
          即过期的银币总额
        </p>
    ...
    <div class="filter-container">
      <n-tabs class="filter-tab" type="segment" animated v-model:value="statusStore.coinsParam.coin_type" @update:value="statusStore.get_coins">
        <n-tab name="" >全部</n-tab>
        <n-tab name="1" >
          银币
          <img class="coin-icon" src="https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/web/FLrDPYmbuUnXSygQF1iePicnQwbPSWXD.webp" />
        </n-tab>
        <n-tab name="2" >
          金币
          <img class="coin-icon" src="https://bizyair-prod.oss-cn-shanghai.aliyuncs.com/web/AdLFMb6DyYnpsJArdSpbPz8P7SzMFw3u.webp" />
        </n-tab>
      </n-tabs>
      <n-select 
        class="filter-select" 
