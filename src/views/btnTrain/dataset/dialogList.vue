<template>
  <div>
        ...
        <div class="dataset-box">
          <div class="header">
            <div class="search">
              <n-input
                placeholder="Search"
                v-model:value="datasetStore.keyword"
                v-debounce="datasetStore.getDatasetList"
              >
                <template #prefix>
                  <svg
            ...
            <n-button type="primary" @click="toUpload">
              <template #icon>
                <svg xmlns="http://www.w3.org/2000/svg" width="96" height="96" viewBox="0 0 24 24">
                  <path fill="currentColor" d="M11.5 20v-7.5H4v-1h7.5V4h1v7.5H20v1h-7.5V20z" />
                </svg>
              </template>
              New Dataset
            </n-button>
    ...
    <n-modal :mask-closable="false" v-model:show="renameInput">
      <n-card style="width: 40vw" :bordered="false" size="huge" role="dialog" aria-modal="true">
        <!-- :on-after-leave="onDialogClose"> -->
