...
const showPagination = computed(() => {
  return (
    modelStoreInstance.modelListPathParams.total /
      modelStoreInstance.modelListPathParams.page_size >
    1
  );
});
...
<template>
  <div v-if="showPagination">
    <Pagination
      v-slot="{ page }"
      :total="modelStoreInstance.modelListPathParams.total"
      :items-per-page="modelStoreInstance.modelListPathParams.page_size"
      :default-page="modelStoreInstance.modelListPathParams.current"
      :sibling-count="1"
      show-edges
