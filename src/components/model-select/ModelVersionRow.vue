...
<template>
  <TableRow
    class="bg-[#3D3D3D] hover:bg-[#4E4E4E] hover:cursor-pointer border-[#F9FAFB]/60 h-12"
  ...
  >
    ...
    <TableCell class="w-[15%] flex justify-start">
      <Button
        variant="default"
        @click.stop="handleApply(version, model)"
  ...
  <vDialog
    v-model:open="showModelDetail"
    class="max-w-full h-screen px-6 overflow-hidden pb-6 z-[8000]"
