  ...
  <div class="flex space-x-2 mb-4">
    ...
    >
      ...
      <PopoverContent
        side="bottom"
        align="end"
        class="w-[150px] p-0 bg-[#353535] rounded-lg"
      >
        <Command>
          <CommandList>
            <CommandGroup>
    ...
    <Popover class="z-[5100]">
      ...
      <PopoverContent
        side="bottom"
        align="end"
        class="w-[200px] p-0 bg-[#222] rounded-lg"
      >
        <Command>
          <CommandList>
            <CommandGroup>
                ...
                <div class="flex flex-wrap gap-2">
                  <Badge
                    ...
                    :class="[
                      ...
                      modelStoreInstance.filterState.model_types.includes(
                        type.value,
                      )
                  ...
                  <Badge
                    ...
                    v-for="model in modelStoreInstance.baseModelTypes.filter(
                      (m: any) =>
                        ...
                        modelStoreInstance.selectedBaseModels?.includes(
                          m.value,
                        ),
                    )"
                    :key="model.value"
                    ...
                    :class="[
                      ...
                      modelStoreInstance.filterState.base_models.includes(
                        model.value,
                      )
                        ? 'bg-[#6D28D9] hover:!bg-[#6D28D9]'
                        : 'bg-[#4E4E4E] hover:!bg-[#4E4E4E]',
