              ...
              >
                <span class="flex items-center gap-2">
                  <svg
                    ...
                    stroke-linejoin="round"
                  >
                    <path d="M2 13.381h20M8.66 19.05V22m6.68-2.95V22m-8.67-9.571h12.65m-12.65 0c-.76 0-1.375-.616-1.375-1.376m1.375 1.376L9.305 9.057M18.66 12.429c.759 0 1.375-.616 1.375-1.376m-1.375 1.376L17.016 9.057m-7.711 0h8.39m-8.39 0c-.759 0-1.375-.616-1.375-1.376v-.19c0-.76.616-1.376 1.375-1.376h8.39c.76 0 1.375.616 1.375 1.376v.19c0 .76-.616 1.376-1.375 1.376m-9.765 2.996v.19c0 .76.616 1.376 1.375 1.376m8.39-1.566v.19c0 .76-.616 1.376-1.375 1.376" />
                  </svg>
                  Workflow
                </span>
              </CommandItem>
