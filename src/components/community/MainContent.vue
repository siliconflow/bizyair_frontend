<script setup lang="ts">
  ...
  const generateMockData = (startId: number, count: number): Model[] => {
    return Array.from({ length: count }, (_, index) => ({
      ...
      imageUrl:
        'https://image.civitai.com/xG1nkqKTMzGDvpLrqFT7WA/0178fcb7-a4cb-403a-8cb0-01964e979ba1/original=true,quality=90/43988648.jpeg',
      stats: {
  ...
  const ITEMS_PER_PAGE = communityStore.mainContent.modelListPathParams.page_size
